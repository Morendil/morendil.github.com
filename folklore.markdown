...
Another arresting fact is the age of this statement. Interestingly enough, what seems t be the [first study](http://portal.acm.org/citation.cfm?id=362858) to mention this wide spread in productivity dates back to 1968 (not entirely coincidentally the year when [Software Engineering](http://confreaks.net/videos/282/)) was born. It presents as a "true" scientific study (as opposed to an opinion piece or an essay), aiming initially to compare, under two experimental conditions, the performance of programmers facing... a **debugging** task. Time required for the programming part of the task are recorded during the study but aren't its main focus. The study finds a statistically significant difference between the two modes considered, "online" and "offline", with a slight effect on performance in favor of the first. The authors also note as a "surprising" observation the large magnitude of the disparity in scores obtained by the various subjects of the study, on several measures of performance.
...
* the 1984 Curtis article does not report on an empirical study, but is an essay calling for better integration of cognitive sciences within software engineering (with which I agree wholeheartedly, but which offers no support for the "10x" claim)
